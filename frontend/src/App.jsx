...
import CreateScout from './pages/squadLeader/CreateScout'
...
export default function App() {
  ...
  return (
    ...
    <Routes>
      ...
      <Route path="/squad-leader/create-scout" element={<RequireAuth roles={['TROOP_LEADER']}><CreateScout /></RequireAuth>} />
